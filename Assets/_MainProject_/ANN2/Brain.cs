...
public class Brain : MonoBehaviour {
    ...
    [SerializeField] private string circuitName = "Circuito1";
    ...
    public static Action<int> onFail;
    ...
    private ManagerCircuits managerCircuits;
    ...
    public float timeScaleValue = 25.0f;


    private void Awake()
    {
        manager = FindObjectOfType<Manager>();
        managerCircuits = FindObjectOfType<ManagerCircuits>();
        flowchart = FindObjectOfType<Flowchart>();
        if (_isAleatoryCircuit) failText = manager.getFailText();
    }
